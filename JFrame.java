...
public class JFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MIlk", "Chocolate", "Soap", "Chicken" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
         ...
         Double bilval = Double.parseDouble(jLabel6.getText());
         Double totalval = Double.parseDouble(total);
         
         Double bilamount = bilval - totalval;
         jLabel6.setText(String.valueOf(bilamount));
         table.removeRow(row);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Double totalval = Double.parseDouble(jLabel9.getText());
        Double bilval = Double.parseDouble(jLabel6.getText());
        
        Double billamount = totalval + bilval;
        jLabel6.setText(String.valueOf(billamount));
